...
public class SPADbContextFactory
{
    ...
    protected static void Seed(SPADbContext _context)
    {
        ...
        _context.Users.AddRange(new[]
        {
            ...
            new User { IdUser = 5, Login = "user2", Pass = "098f6bcd4621d373cade4e832627b4f6", PassDate = new DateTime(2050,1,1), IsActive = "F", Name = "Application user 2", Description = "Application user 2 description" },
            new User { IdUser = 6, Login = "viewer", Pass = "098f6bcd4621d373cade4e832627b4f6", PassDate = new DateTime(2000,1,1), IsActive = "T", Name = "Read only user", Description = "Read only user description" },
        });
