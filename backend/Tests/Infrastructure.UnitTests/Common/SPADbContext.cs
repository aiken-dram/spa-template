...
public class SPADbContextFactory
{
    ...
    protected static void Seed(SPADbContext context)
    {
        ...
        {
                new User { IdUser = 1, Login = "admin", Pass = "21232f297a57a5a743894a0e4a801fc3", IsActive = "T", Name = "Application admin", Description = "Application admin description" },
                new User { IdUser = 2, Login = "user", Pass = "098f6bcd4621d373cade4e832627b4f6", IsActive = "T", Name = "Application user", Description = "Application user description" },
                new User { IdUser = 3, Login = "viewer", Pass = "098f6bcd4621d373cade4e832627b4f6", IsActive = "T", Name = "Read only user", Description = "Read only user description" },
            });
        ...
        context.Roles.AddRange(new[]
        {
                ...
                new Role { IdRole = 1, Name = "Application admins", Description = "Application management role" },
                new Role { IdRole = 2, Name = "Supervisor", Description = "Supervisor role" },
                new Role { IdRole = 3, Name = "Read only", Description = "Read only restriction role" },
            });
